    ...
    def handle(self, *args, **options):
        ...
        for i in range(100):
            ...
            profile_data = {
                ...
                'last_name': last_name,
                'email': email,
                'DOB': date(random.randint(1975, 2005), random.randint(1, 12), random.randint(1, 28)),
        ...
        self.stdout.write(self.style.SUCCESS(f"Successfully seeded {created_count} profiles."))
