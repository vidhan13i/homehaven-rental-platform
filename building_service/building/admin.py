...
class BuildingAdmin(admin.ModelAdmin):
    list_display = [
        'name', 'city', 'state', 'Pin_code',
        'no_of_floors', 'no_of_units',
        'avg_rating', 'review_count',
        'is_RERA_verified', 'created_at',
    ]
    list_filter = [
        'is_RERA_verified', 'is_gym', 'is_swimming',
        'is_garden', 'is_elevator', 'city', 'state',
    ]
    ...
    fieldsets = (
        ...
        ('Building Details', {
            'fields': ('built_year', 'no_of_units', 'no_of_floors')
        }),
        ('Amenities', {
