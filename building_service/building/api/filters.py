...
class BuildingFilter(django_filters.FilterSet):
    ...
    # ── Size filters ──
    min_floors = django_filters.NumberFilter(field_name='no_of_floors', lookup_expr='gte')
    max_floors = django_filters.NumberFilter(field_name='no_of_floors', lookup_expr='lte')
    ...
    # ── Built year ──
    built_after = django_filters.NumberFilter(field_name='built_year', lookup_expr='gte')
    built_before = django_filters.NumberFilter(field_name='built_year', lookup_expr='lte')
