...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        building_prefixes = [
            'Skyline', 'Green Valley', 'Ocean View', 'Sunrise', 'Royal',
            'Metro', 'Paradise', 'Golden', 'Silver Oak', 'Crystal',
            'Diamond', 'Emerald', 'Parkway', 'Summit', 'Ridgeview'
        ]
        ...
        self.stdout.write(self.style.SUCCESS(f"Successfully seeded {created_count} buildings."))