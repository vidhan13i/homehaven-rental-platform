...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options["clear"]:
            self.stdout.write(
                "Clearing existing applications, applicants, and documents..."
            )
        ...
        for j in range(50):
            ...
            applicant, created = Applicant.objects.get_or_create(
                ...
                defaults={
                    ...
                    "expected_movein_date": date(2026, 7, 1)
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully seeded {created_applicants} applicants and {created_applications} applications."
            )
        )
