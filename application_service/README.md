...
- **ReDoc**: [http://localhost:8005/api/redoc/](http://localhost:8005/api/redoc/)
- **Raw OpenAPI Schema**: [http://localhost:8005/api/schema/](http://localhost:8005/api/schema/)

### How to Generate Schema File
To export the schema as a YAML file for external clients or Postman:
```bash
docker compose exec application_service python manage.py spectacular --file schema.yml
```
