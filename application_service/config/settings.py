"""
Django settings for application_service.
"""
...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,gateway,application_service").split(",")
...
DATABASE_ROUTERS = ["config.db_router.ApplicationRouter"]
