...
- **Raw OpenAPI Schema**: [http://localhost:8003/api/schema/](http://localhost:8003/api/schema/)

### How to Generate Schema File
To export the schema as a YAML file for external clients or Postman:
```bash
docker compose exec listings_service python manage.py spectacular --file schema.yml
```
