...
def benchmark_producer():
    ...
    print(f"Producer Throughput: {throughput:.2f} msgs/sec | Total Time: {duration:.2f}s")
...
def benchmark_consumer():
    ...
    print(f"Consumer Throughput: {throughput:.2f} msgs/sec | Total Time: {duration:.2f}s")
    consumer.close()
