...
class ReviewAdmin(admin.ModelAdmin):
    list_display = [
        'Title', 'building_ID', 'profile_ID',
        'cleanliness_rating', 'water_supply_rating',
        'status', 'is_pet_friendly', 'is_received_deposit',
        'review_date',
    ]
    ...
    fieldsets = (
        ('Review Info', {
            'fields': ('profile_ID', 'building_ID', 'full_address', 'unit_no', 'status')
        }),
        ('Content', {
